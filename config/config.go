...
func GetConfig() *Config {
	...
	maxOutputSize := flag.Int64("max_output_size", 16*1024*1024, "Max Output Size (byte)")
	exePath := flag.String("exe_path", "./main", "Exe Path")
	inputPath := flag.String("input_path", "/dev/stdin/in", "Input Path")
	outputPath := flag.String("output_path", "/dev/stdout/out", "Output Path")
	errorPath := flag.String("error_path", "/dev/stderr/err", "Error Path")
	args := flag.Args()
